...
public class FunctionRegistry {
    ...
    private static Class getFnIface(String name) throws UDFCompileException {
        switch (name) {
            case "Fn": return Fn.class;
            case "Fn0": return Fn0.class;
            case "Fn1": return Fn1.class;
            case "Fn2": return Fn2.class;
            case "Fn3": return Fn3.class;
            case "Fn4": return Fn4.class;
            case "Fn5": return Fn5.class;
            case "AFn": return AFn.class;
            case "AFn0": return AFn0.class;
            case "AFn1": return AFn1.class;
            case "AFn2": return AFn2.class;
            case "AFn3": return AFn3.class;
            case "AFn4": return AFn4.class;
            case "AFn5": return AFn5.class;
        }
